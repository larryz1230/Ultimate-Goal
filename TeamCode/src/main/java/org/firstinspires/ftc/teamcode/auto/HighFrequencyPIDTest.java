...
public class HighFrequencyPIDTest extends LinearOpMode {
    ...
    public static double kD = 0.000035;

    public static PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(kP, kI, kD);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DcMotorEx myMotor2 = hardwareMap.get(DcMotorEx.class, "inverted");
        myMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);

        DcMotorEx passthrough = hardwareMap.get(DcMotorEx.class, "intake");
        passthrough.setDirection(DcMotorSimple.Direction.REVERSE);

        passthrough.setPower(0.5);
        ...
        while (!isStopRequested() && opModeIsActive()) {
            ...
            double power = veloController.update(myMotor.getCurrentPosition(), motorVelo);
